        ...
        <div className='space-y-6'>
          {experiences.map((item) => (
            <article
              ...
              className='rounded-2xl border border-neutral-800 bg-gradient-to-b from-neutral-900/80 to-neutral-950/40 p-5 sm:p-7'
            >
              <div className='flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
                <div>
                  <h2 className='text-xl font-bold text-neutral-100 sm:text-2xl'>{item.role}</h2>
                  <p className='mt-1 text-base font-semibold text-orange-700 sm:text-lg'>{item.company}</p>
                </div>
