    ...
    <section id='contact' className='min-h-screen w-full pb-16 pt-24 text-white'>
      <div className='mx-auto max-w-6xl'>
        ...
        <div className='grid gap-6 lg:grid-cols-[0.85fr_1.15fr]'>
            {/* left side */}
          <aside className='rounded-2xl border border-neutral-800 bg-gradient-to-b from-neutral-900/80 to-neutral-950/40 p-5 sm:p-8'>
            <h2 className='text-xl font-bold text-neutral-100 sm:text-2xl'>Get in touch</h2>
            ...
            <div className='mt-8 space-y-3'>
              <a
                ...
                className='group flex items-center gap-3 rounded-xl border border-neutral-800 bg-neutral-950/50 px-3.5 py-3 transition duration-300 hover:border-orange-700/60 hover:bg-neutral-900 sm:px-4'
              >
                <span className='flex h-10 w-10 items-center justify-center rounded-lg bg-orange-700/15 text-orange-300'>
                  <Mail size={18} />
                </span>
                <span className='min-w-0 break-all text-sm text-neutral-300'>anubhavgupta1045@gmail.com</span>
              </a>
              ...
              <div className='flex items-center gap-3 rounded-xl border border-neutral-800 bg-neutral-950/50 px-3.5 py-3 sm:px-4'>
                <span className='flex h-10 w-10 items-center justify-center rounded-lg bg-orange-700/15 text-orange-300'>
                  <MapPin size={18} />
                </span>
        ...
        {/* right side */}
          <form
            ...
            className='rounded-2xl border border-neutral-800 bg-gradient-to-b from-neutral-900/80 to-neutral-950/40 p-5 sm:p-8'
          >
            ...
            <div className='mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
              <button
                ...
                className='inline-flex w-full items-center justify-center gap-2 rounded-full bg-orange-700 px-5 py-3 text-sm font-medium text-white transition duration-300 hover:bg-orange-800 disabled:cursor-not-allowed disabled:opacity-60 sm:w-fit'
              >
